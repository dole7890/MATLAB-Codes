...
IMU_errors.G_g = [0 0 0;0 0 0;0 0 0];
...
IMU_errors.gyro_noise_root_PSD = 0.1 * deg_to_rad / 60;
...
[out_profile,out_errors] = Inertial_navigation_NED_test(in_profile,no_epochs,...
...
figure()
plot(rad2deg(out_profile(1:1000,2)),rad2deg(out_profile(1:1000,3)))
