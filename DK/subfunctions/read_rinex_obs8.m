...
while (current_line ~= -1) & (epoch_count < max_epochs)
    ...
    current_line = current_line(4:end);
    % Check event flag
    event_flag = str2num(current_line(29));
    % note from Kristine
...
%     end
    ...
    while ~contains(current_line,'>')
        ...
        current_prn = str2double(current_line(2:3));
        current_obs = [ str2num(current_line( 4:19)); str2num(current_line(20:35)); ...
                str2num(current_line(36:52)); str2num(current_line(53:67))];
        current_data = [ gpswk, gpssec, current_prn , current_obs'];
        %{
        [ current_line ] = check_rinex_line_length(current_line);
