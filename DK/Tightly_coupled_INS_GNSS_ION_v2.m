...
if strcmp(mode,'real')
    ...
    GNSS_measurements = [dat_rinex.data(idx,dat_rinex.col.C1) -dat_rinex.data(idx,dat_rinex.col.D1)/1575.42e6*settings.c xs xdots];
...
%     if time_GNSS > time_imu
        ...
        plot(lla(2),lla(1),'b.')
        lla2 = ecef2lla(true_r_eb_e');
        true_lambda_b = deg2rad(lla2(2));
        true_L_b = deg2rad(lla2(1));
